    ...
    public static async Task InitializeAsync(ApplicationDbContext context)
    {
        ...
        if (context.Database.IsSqlServer())
        {
            await context.Database.ExecuteSqlRawAsync(@"
                ...
                IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'DonationCampaigns')
                BEGIN
                    CREATE TABLE [DonationCampaigns] (
                        [Id] int NOT NULL IDENTITY,
                        [TitleEnglish] nvarchar(200) NOT NULL,
                        [TitleMarathi] nvarchar(200) NOT NULL,
                        [SummaryEnglish] nvarchar(500) NULL,
                        [SummaryMarathi] nvarchar(500) NULL,
                        [DescriptionEnglish] nvarchar(max) NOT NULL,
                        [DescriptionMarathi] nvarchar(max) NOT NULL,
                        ...
                        CONSTRAINT [PK_DonationCampaigns] PRIMARY KEY ([Id])
                    );
                END
                ...
                BEGIN
                    CREATE TABLE [Donations] (
                        ...
                        [DonorMobile] nvarchar(20) NOT NULL,
                        [DonorEmail] nvarchar(150) NULL,
                        [DonorPanNumber] nvarchar(20) NULL,
                        ...
                        CONSTRAINT [FK_Donations_DonationCampaigns_CampaignId] FOREIGN KEY ([CampaignId]) REFERENCES [DonationCampaigns] ([Id]) ON DELETE SET NULL
                    );
                END
            ");
        }

        // Ensure Donation tables exist in PostgreSQL / Supabase
        if (string.Equals(context.Database.ProviderName, "Npgsql.EntityFrameworkCore.PostgreSQL", StringComparison.OrdinalIgnoreCase))
        {
            await context.Database.ExecuteSqlRawAsync(@"
                CREATE TABLE IF NOT EXISTS ""DonationCampaigns"" (
                    ""Id"" integer GENERATED BY DEFAULT AS IDENTITY,
                    ""TitleEnglish"" character varying(200) NOT NULL,
                    ""TitleMarathi"" character varying(200) NOT NULL,
                    ""SummaryEnglish"" character varying(500) NULL,
                    ""SummaryMarathi"" character varying(500) NULL,
                    ""DescriptionEnglish"" text NOT NULL,
                    ""DescriptionMarathi"" text NOT NULL,
                    ""TargetAmount"" numeric(18,2) NOT NULL,
                    ""RaisedAmount"" numeric(18,2) NOT NULL DEFAULT 0,
                    ""BannerImageUrl"" character varying(500) NULL,
                ...
                CREATE TABLE IF NOT EXISTS ""Donations"" (
                    ...
                    ""DonorMobile"" character varying(20) NOT NULL,
                    ""DonorEmail"" character varying(150) NULL,
                    ""DonorPanNumber"" character varying(20) NULL,
                    ""City"" character varying(100) NULL,
                    ""Amount"" numeric(18,2) NOT NULL,
                    ""PaymentMethod"" character varying(50) NOT NULL,
                    ""UtrNumber"" character varying(100) NULL,
                    ""PaymentStatus"" character varying(50) NOT NULL DEFAULT 'Pending',
                    ""ReceiptNumber"" character varying(50) NOT NULL,
                    ""IsAnonymous"" boolean NOT NULL DEFAULT FALSE,
                    ""Notes"" character varying(500) NULL,
                    ""DonatedAt"" timestamp with time zone NOT NULL,
        ...
        // 1. Seed Organization Info (only if empty)
        ...
        // 2. Seed Designations (only if empty)
        if (!await context.Designations.AnyAsync())
        {
            ...
            await context.Designations.AddRangeAsync(designationsList);
            await context.SaveChangesAsync();
        }

        // Get designation IDs for member seeding (needed whether designations were just seeded or already existed)
        var designations = await context.Designations.ToListAsync();

        // 3. Seed Members (only if empty)
        ...
        // 4. Seed Activities (only if empty)
        ...
        // 6. Seed Gallery Albums & Images (only if empty)
        if (!await context.GalleryAlbums.AnyAsync())
        {
        ...
        // 8. Seed Donation Campaigns (only if empty)
        if (!await context.DonationCampaigns.AnyAsync())
        {
            var campaigns = new List<DonationCampaign>
            {
                new()
                {
                    TitleEnglish = "Emergency Ambulance & Rural Healthcare Fund",
                    TitleMarathi = "ग्रामीण रुग्णवाहिका व मोफत आरोग्य सेवा निधी",
                    SummaryEnglish = "Raising funds to acquire a dedicated community ambulance to provide free emergency transport and medicine in rural Maharashtra.",
                    SummaryMarathi = "ग्रामीण भागातील आपत्कालीन रुग्णांना मोफत व वेळेवर उपचार मिळण्यासाठी स्वतंत्र रुग्णवाहिका व औषधोपचार निधी मोहीम.",
                    DescriptionEnglish = "In many rural talukas of Maharashtra, lack of timely ambulance services poses a severe risk during emergencies. Lion Group Maharashtra Rajya is launching this dedicated campaign to purchase and operate a fully-equipped medical ambulance service available 24/7 at zero cost for underprivileged families.",
                    DescriptionMarathi = "महाराष्ट्रातील दुर्गम आणि ग्रामीण भागात वेळेवर रुग्णवाहिका न मिळाल्यामुळे अनेक निष्पाप रुग्णांचे प्राण धोक्यात येतात. लायन ग्रुप महाराष्ट्र राज्य या सामाजिक संस्थेच्या वतीने सर्वसामान्य व गरजू जनतेसाठी २४ तास मोफत अत्याधुनिक रुग्णवाहिका सेवा सुरू करण्याचा हा संकल्प आहे. आपल्या लहानशा मदतीने अनेक गरजू रुग्णांना जीवनदान मिळू शकते.",
                    TargetAmount = 500000,
                    RaisedAmount = 145000,
                    BannerImageUrl = "/uploads/bhushan4.jpeg",
                ...
                new()
                {
                    TitleEnglish = "Underprivileged Students Education & Kit Drive",
                    TitleMarathi = "गरजू विद्यार्थ्यांसाठी शैक्षणिक दत्तक व साहित्य मोहीम",
                    SummaryEnglish = "Providing school bags, books, uniforms, and educational scholarships to 500+ meritorious students from drought-affected families.",
                    SummaryMarathi = "दुर्गम व दुष्काळग्रस्त भागातील ५००+ होतकरू विद्यार्थ्यांना शालेय दप्तर, वह्या, गणवेश व शिष्यवृत्ती साहाय्य.",
                    DescriptionEnglish = "Education is the foundation of a bright future. Lion Group Maharashtra Rajya identifies bright students from economically challenged backgrounds across Maharashtra and supports their entire academic year with kits, stationery, and fees assistance.",
                    DescriptionMarathi = "शिक्षण हा प्रत्येक मुलाचा मूलभूत अधिकार आहे. आर्थिक अडचणींमुळे एकाही गुणवंत विद्यार्थ्याचे शिक्षण थांबू नये, यासाठी लायन ग्रुप महाराष्ट्र राज्याच्या वतीने राज्यातील ५०० हून अधिक गरजू विद्यार्थ्यांना संपूर्ण शैक्षणिक वर्षभरासाठी वह्या, पुस्तके, दप्तर आणि फी मदत पुरवली जात आहे.",
                    TargetAmount = 250000,
                    RaisedAmount = 92500,
                    BannerImageUrl = "/uploads/bhushan.jpeg",
            ...
            await context.DonationCampaigns.AddRangeAsync(campaigns);
            await context.SaveChangesAsync();
        }
    }
}
